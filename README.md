...
##  性格・意欲・興味 etc..
- Webデザインと実装はできるようになったが、作って終わりのデザインに違和感を感じる。
- いろんな仕事をちょっとずつすることも可能だが、１個1個の確実に終わらせてつつ進める方がより向いている。（企業から毎回スピードを評価されている）
- 制作において、明かに無駄なことやユーザにとってマイナスになることなどが発生する場合、理解するまできちんと話し合いたい。
- 一人でデザイン〜実装まで対応する機会が多く、自走力はあります
